#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Anmol x somi
...
logo = """
 ...
 '\033[1;97m▒█▄▄█ █░░█ █░▀░█ █░░█ █░░ 
 '\033[1;98m▒█░▒█ ▀░░▀ ▀░░░▀ ▀▀▀▀ ▀▀▀
\033[1;96m«-----------------\033[1;97mAwanMafia\033[1;91m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  AwanMafia
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  Anmol hacker
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈ 
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ +913455453538
...
def menu():
    ...
    time.sleep(0.05)
    print("\033[1;41m2\033[1;34m       Stop Process Press CTRL + z        \033[1;0m")
    time.sleep(0.05)
    print("\033[1;41m3\033[1;35m         Type python2 Swagboy.py          \033[1;0m")
    time.sleep(0.05)
    print("\033[1;91m[1]  Install With Out Fb Id  Tool      ●")
    time.sleep(0.05)
    print("\033[1;98m[2]  Install Facebook login  Tool      ●")
    time.sleep(0.05)
    print("\033[1;91m[3]  Install SpiderMan       Tool      ●")
    time.sleep(0.05)
    print("\033[1;92m[4]  Install Kalilinux       Tool      ●")
    time.sleep(0.05)
    print("\033[1;93m[5]  Install BlackHat        Tool      ●")
    time.sleep(0.05)
    print("\033[1;94m[6]  Install RedMoonNew      Tool      ●")
    time.sleep(0.05)
    print("\033[1;97m[7]  Install love3Hack3r     Tool      ●")
    time.sleep(0.05)
    print("\033[1;91m[8]  Install Cobra           Tool      ●")
    time.sleep(0.05)
    print("\033[1;92m[9]  Install Dragon          Tool      ●")
    time.sleep(0.05)
    print("\033[1;93m[10] Install NetHunting      Tool      ●")
    time.sleep(0.05)
    print("\033[1;94m[11] Install Payload         Tool      ●")
    time.sleep(0.05)
    print("\033[1;95m[12] Install CamHacker       Tool      ●")
    time.sleep(0.05)
    print("\033[1;96m[13] Install Compiler        Tool      ●")
    time.sleep(0.05)
    print("\033[1;97m[14] Install Instagram Brut  Tool      ●")
    time.sleep(0.05)
    ...
    mafia()
def mafia():
	black = raw_input("\033[1;97m slect option>>>   ")
	if black =="":
		...
		os.system("cd Osama")
	        ...
	        os.system("cd $HOME && git clone https://github.com/lovehacker404/Spider")
                print (logo)
	        love("\033[1;98mCongratulations Cobra Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;97mTool User Name SpiderMan Password lovehacker")
                time.sleep(5)
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/KaliIndia")
                print (logo)
		love("\033[1;97mCongratulations AwanMafia Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		love("\033[1;92mTool User Name India Password Anmolhacker")
                time.sleep(5)
		...
		love("\033[1;93mTool User Name BlackHat Password lovehacker")
	        ...
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name\033[1;92m RedMoonNew\033[1;91m Password \033[1;97mlovehacker")
                time.sleep(6)
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/lov3Hak3r")
                print (logo)
		love("\033[1;95mCongratulations AwanMafia Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/Somi190/Cobra")
                print (logo)
	        love("\033[1;91mCongratulations Cobra Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;98mTool User Name Cobra  Password lovehacker")
                time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/lovehacker404/Dragon")
                print (logo)
	        love("\033[1;96mCongratulations Dragon Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                love("\033[1;91mTool User Name Dragon  Password lovehacker")
                time.sleep(5)
		...
		love("Now you can open this tool as usual")
                love("\033[1;97mTool User Name linux Password lovehacker")
		time.sleep(5)
	        ...
	        os.system("cd $HOME && git clone https://github.com/Somi190/Awan_Mafia")
                print (logo)
		...
		os.system("cd $HOME && git clone https://github.com/Somi190/Pak")
                print (logo)
		love("\033[1;96mCongratulations CamHacker Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
                love("\033[1;92mEducational Perpose only")
		time.sleep(2)
                os.system("cd $HOME/Pak && python anmolhacker.py")
        elif black =="13":
		clear()
                print(logo)
		os.system("rm -rf $HOME/Compile")
	        os.system("cd $HOME && git clone https://github.com/Somi190/Compile")
                print (logo)
	        ...
	        os.system("cd $HOME && git clone https://github.com/Somi190/World")
                print (logo)
	        love("\033[1;93mCongratulations  Tool Has Been Update Successfully")
	        love("Now you can open this tool as usual")
                time.sleep(5)
		...
		print(logo)
		os.system("rm -rf $HOME/World")
		os.system("cd $HOME && git clone https://github.com/Awanmafia190/World")
                print (logo)
